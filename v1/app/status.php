...
<div class="modal fade" id="addModal">
    <div class="modal-dialog">
        <div class="modal-content">
            <form class="form-horizontal" action="action/admin/add-status.php" method="POST">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td style='width: 100px;'>
                                        <a href="index.php?page=status-edit&& id=<?php echo $id; ?>"
                                            class=" btn btn-sm btn-info">
                                            <i class="fas fa-solid fa-pen"></i>
                                        </a>

                                        <a onclick="delete_status('<?php echo $id; ?>')" class=" btn btn-sm btn-danger">
...
<script>
function delete_status(data_id) {
    // alert('ok');
