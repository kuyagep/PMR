        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item"><a href="category">Purchase Category</a></li>
                    <li class="breadcrumb-item active">Edit Purchase Category</li>
                </ol>
            </div><!-- /.col -->
        </div><!-- /.row -->
    </div><!-- /.container-fluid -->
            ...
            <div class="col-lg-8">
                <div class="card mb-4 card-outline card-red">
                    ...
                    <div class="card-body">
                        ...
                        <input type="hidden" name="id" value="<?php echo $view['pcategory_id']; ?>">

                        <div class="form-group row">
                            <label for="category" class="col-sm-3 col-form-label">Purchase Category</label>
                            <div class="col-sm-9">
                                <input type="text" class="form-control" name="category"
                                    value="<?php echo $view['category_name']; ?>" placeholder="Purchasen Category" required>
                            </div>
                        </div>
