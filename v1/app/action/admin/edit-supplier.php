        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item"><a href="index.php?page=employee">Supplier</a></li>
...
<!-- style=" background-color: #eee; -->
    <div class="container py-5">
        <form action="action/admin/update-supplier.php" method="POST" enctype="multipart/form-data">
            <div class="row">
                <div class="col-lg-8">
                    <div class="card mb-4 card-outline card-red">
                        ...
                        <div class="card-body">
                            ...
                            <input type="hidden" name="id" value="<?php echo $view['supplier_id']; ?>">

                            <div class="form-group row">
                                <label for="supplier" class="col-sm-3 col-form-label">Supplier Name</label>
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" name="supplier"
                                        value="<?php echo $view['supplier_name']; ?>" placeholder="Supplier Name"
                                        required>
                                </div>
                            </div>
                            <hr>
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" name="address"
                                        value="<?php echo $view['address']; ?>" placeholder="Address">
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" name="contact"
                                        value="<?php echo $view['contact_no']; ?>" placeholder="Contact No.">
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" name="email"
                                        value="<?php echo $view['email_add']; ?>" placeholder="Email Address">
                                </div>
                            </div>

                        </div>
                        <div class="card-footer">
                            <button type="submit" name="updateSupplier" class="btn btn-primary float-right ml-3 ">
