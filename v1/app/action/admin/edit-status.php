        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item"><a href="index.php?page=employee">Status</a></li>
...
<!-- style=" background-color: #eee; -->
    <div class="container py-5">
        <form action="action/admin/update-status.php" method="POST" enctype="multipart/form-data">
            <div class="row">
                <div class="col-lg-8">
                    <div class="card mb-4 card-outline card-red">
                        ...
                        <div class="card-body">
                            ...
                            <input type="hidden" name="id" value="<?php echo $view['status_id']; ?>">

                            <div class="form-group row">
                                <label for="status" class="col-sm-3 col-form-label">Status Name</label>
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" name="status"
                                        value="<?php echo $view['status_desc']; ?>" placeholder="Status Name" required>
                                </div>
                            </div>

                        </div>
                        <div class="card-footer">
                            <button type="submit" name="updateStatus" class="btn btn-primary float-right ml-3 ">
...
function delete_employee(data_id) {
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            ...
            window.location = ("action/admin/delete-status.php?id=" + data_id);
            // Swal.fire(
            //             'Deleted!',
